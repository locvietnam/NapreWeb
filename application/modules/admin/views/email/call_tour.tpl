                        ...
                        <table width="650" cellpadding="0" cellspacing="0" border="0" align="center" class="devicewidth">
                           <tbody>
                              ...
                              <tr>
								...
								<a href="http://www.airtrippy.vn/" style="outline: none;" title="Tazto"><img src="{$base_tlp_user}/images/logo.png" alt="Tazto" class="logo-img" style="border: 0;display: block;-ms-interpolation-mode: bicubic;"></a>								</td>
                              </tr>
							  </table>
							 </td>
							 </tr>                  
                  ...
                  <tr>
                     <td width="100%">
					   ...
					   <table width="650" align="center" border="0" cellpadding="0" cellspacing="0" class="devicewidth" style="background-color:#f8b92c;">
						...
						<span style="text-decoration: none; outline: none;color:#fff;">Yêu cầu đăng tour</span></td>
						</tr>
						</table>
										...
										<tr>
											<td width="10">
												...
												<table width="580" style=" border-bottom:2px solid #0194E9">
													<tr>
														<td><strong>Yêu Cầu Đăng Tour</strong>:</td>
													</tr>
												</table>
												<br />

													Agency {$params.agency_name} gửi thông tin đăng tour như sau:<br /> <br />
                                                    
                                                    Tour: {$params.tour_category} <br/>
                                                    Email : {$params.email}     <br/>
                                                    Phone : {$params.phone}     <br/>
                                                    Tin nhắn : {$params.message} <br/>
													
													Upload file thông tin tour: <a href="{$params.link_file_upload}">{$params.link_file_upload}</a>
