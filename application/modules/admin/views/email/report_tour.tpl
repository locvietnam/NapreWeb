       ...
       <td width="100%">
        ...
        <table width="650" align="center" border="0" cellpadding="0" cellspacing="0" class="devicewidth" style="background-color:#f8b92c;">
          <tr>
           ...
           <span style="text-decoration: none; outline: none;color:#fff;">Report Form</span></td>
          </tr>
        </table>
            ...
            <table width="600" align="center" border="0" cellspacing="0" cellpadding="0" class="devicewidthinner" style="border-collapse: collapse;background-color:#FFFFFF;" background="#fff;">
              ...
              <tr>
                ...
                <td class="h3 b title-td"  style="color:#000000;font-size:14px;font-family:Arial;">
                  ...
                  <table width="580">
                   <tr>
                     <td>
                      <br />
                      {$params.email_receiver} thân mến<br />
                      <br />
                    </td>
                  </tr>
                </table>
                ...
                <table width="580" style=" border-bottom:2px solid #0194E9">
                  <tr>
                    <td><strong>Thống Kê Agencey: {$params.agency_name}</strong>:</td>
                  </tr>
                </table>
                <br />

                Agency <strong>{$params.agency_name}</strong> gửi thông tin thống kê trên Airtrippy:<br /> <br />
                <strong>Nhấp chuột vào <a href="{$params.link_thong_ke}">link thống kê</a> để xem</strong></a>
                <br />
                Hoặc: <a href="{$params.link_thong_ke}">{$params.link_thong_ke}</a>
                <br />
                <br />
                Chúc công việc kinh doanh của bạn luôn thành công<br /> 
                <br />
