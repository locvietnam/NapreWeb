                        ...
                        <table width="650" cellpadding="0" cellspacing="0" border="0" align="center" class="devicewidth">
                           <tbody>
                              ...
                              <tr>
								...
								<a href="{$params.base_url}" style="outline: none;" title="Aline"><img src="{$params.base_url}images/logo.png" alt="Aline" class="logo-img" style="border: 0;display: block;-ms-interpolation-mode: bicubic;"></a>								</td>
                              </tr>
							  </table>
							 </td>
							 </tr>                  
                  ...
                  <tr>
                     <td width="100%">
					   ...
					   <table width="650" align="center" border="0" cellpadding="0" cellspacing="0" class="devicewidth" style="background-color:#f8b92c;">
						...
						<span style="text-decoration: none; outline: none;color:#fff;">{$params.email_title}</span></td>
						</tr>
						</table>
										...
										<tr>
											<td width="10">
												...
												<table width="580" style=" border-bottom:2px solid #0194E9">
													<tr>
														<td><strong>{$params.email_title}</strong>:</td>
													</tr>
												</table>
												<br />

													Please use the following link to <a href="{$params.link_confirm}">Reset Password.</a><br /> <br />
													...
													If you do not request this password change please feel free to ignore it.<br />
                                                                                                        If you have any comment or questions, please don't hesitate to reach us <a href="{$params.email_support}">{$params.email_support}</a>
													<br />
													<br />
													<br />
