                                    ...
                                    <table align="left" class="fn">
                                       <tr>
                                        <td width="265" style="padding: 18px 0 24px;">
                                           <a href="http://www.airtrippy.vn/" style="outline: none;" title="Airtrippy"><img src="{$base_tlp_user}/images/logo.png" alt="Tazto" class="logo-img" style="border: 0;display: block;-ms-interpolation-mode: bicubic;"></a>								</td>
                                        </tr>
                                     </table>
                                  </td>
                               </tr>                  
                      ...
                      <table width="650" align="center" border="0" cellpadding="0" cellspacing="0" class="devicewidth" style="background-color:#f8b92c;">
                        <tr>
                           <td align="center" class="h6" height="35" style="font-family: Arial;color: #fff;font-size: 14pt;line-height: 18px;">
                              <span style="text-decoration: none; outline: none;color:#fff;">Pricing Form</span></td>
                           </tr>
                        </table>
                                      ...
                                      <tr>
                                       ...
                                       <td class="h3 b title-td"  style="color:#000000;font-size:14px;font-family:Arial;">
                                         ...
                                         <table width="580" style=" border-bottom:2px solid #0194E9">
                                            <tr>
                                              <td><strong>Price Form</strong>:</td>
                                           </tr>
                                        </table>
                                        <br />

                                        Agency <strong>{$params.agency_name}</strong> gửi thông tin gói backage như sau:<br /> <br />

                                        <strong>Tin nhắn</strong> : {$params.message} <br/> <br/>
                                        <strong>Email</strong> : {$params.email} <br/><br/>
                                        <strong>Phone</strong> : {$params.phone}   <br/><br/>
                                        {if $params.link_file_hinh neq ''}
                                        <strong>File hình hóa đơn</strong>: <a href="{$params.link_file_hinh}">{$params.link_file_hinh}</a>
										{/if}
                                        <br />
                                        <br />
                                        Admin hãy vào <a href="{$params.base_url_admin}">phần quản trị thông tin</a> để kiểm tra & thiết lập gói cho Agency thông tin<br /> 
