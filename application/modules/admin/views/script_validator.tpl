...
<script src="{$base_tlp_admin}/assets/components/common/forms/validator/assets/lib/jquery-validation/dist/jquery.validate.min.js?v=v1.0.3-rc2"></script>
<script src="{$base_tlp_admin}/assets/components/common/forms/validator/assets/custom/form-validator.init.js?v=v1.0.3-rc2"></script>
