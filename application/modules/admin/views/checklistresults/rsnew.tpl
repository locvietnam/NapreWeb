			<section class="content-header">
            	<form class="form-horizontal margin-none" action="" method="get" name="fnewchecklistresults" id="fnewchecklistresults" data-required_day_month_year="{$lable.please_choose_day_month_year}" data-requiredstaff="{$lable.staff_required}" >
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-custom text-center text-bold">
                        <tr class="text-purple f-16">   
                            ...
                            <th >{$lable.checklist}</th>
                            <th style="min-width: 200px; width: 100px;">{$lable.staff}</th>
                            <th style="min-width: 120px; width: 120px;">{$lable.emoticon}</th>
                            <th style="min-width: 120px; width: 120px;">{$lable.date}</th>
                            <th style="min-width: 180px; width: 120px;">{$lable.task}</th>
                        </tr>                        
                        {if $list}
