...
class Reportchecklist_bak extends MY_Controller {
	...
	<table style="width: 100%; vertical-align:middle;" cellpadding="0" cellspacing="0" align="center">
		<tr>
			<th style="min-width: 20%; width: 20%; background-color: #A72529; text-align: center; color: #fff; height: 40px; line-height: 25px;">' . $this->lable['reportchecklist_day_of_month'] . '
			</th>
			<th style="min-width: 20%; width: 20%; background-color: #A72529; text-align: center; color: #fff; height: 40px; line-height: 25px;">
			' . $this->lable['reportchecklist_percent_completion'] . '(%)
			</th>
			<th style="min-width: 60%; width: 60%; background-color: #A72529; text-align: center; color: #fff; height: 40px; line-height: 25px;">
			' . $this->lable['reportchecklist_icon'] . '
			</th>
		</tr>  ';                      
		
			foreach($this->_data['list'] as $item):
		$html .= '<tr>
			<td style="text-align: center; border-left: 1px solid #F3DAF3;border-bottom: 1px solid #F3DAF3; line-height: 60px;  padding: 10px;">
			' . $item->fdate_add . '
			</td>
			<td style="text-align: center; border-left: 1px solid #F3DAF3;border-bottom: 1px solid #F3DAF3; line-height: 60px;  padding: 10px;">
			'.$item->percent.'
			</td>
			<td style="text-align: center; border-left: 1px solid #F3DAF3; border-right: 1px solid #F3DAF3; border-bottom: 1px solid #F3DAF3; ">';
					foreach($item->users as $itemSub):
						if ($itemSub['emotion_icon'] == 1 ):
								$html .= '<img style="width: 50px;" src="' . $this->_data['base_tlp_admin'] . '/img/icon/mat-1-xanh.png" alt="{$itemSub.user_fullname}">';

						elseif ($itemSub['emotion_icon'] == 2):
								$html .= '<img style="width: 50px;" src="' . $this->_data['base_tlp_admin'] . '/img/icon/mat-2-xanh.png" alt="{$itemSub.user_fullname}">';

						elseif ($itemSub['emotion_icon'] == 3):
								$html .= '<img style="width: 50px;" src="' . $this->_data['base_tlp_admin'] . '/img/icon/mat-3-xanh.png" alt="' . $itemSub['user_fullname'] . '">';
						endif;
					endforeach;  
			$html .= '</td>
		</tr>';
		endforeach;
		$html .= '<tr>
			<td style="text-align: right; border-left: 1px solid #F3DAF3;border-bottom: 1px solid #F3DAF3;  height: 25px; line-height: 25px;">
				' . $this->lable['total_percent'] . '
			</td>
			<td style="text-align: center; border-left: 1px solid #F3DAF3;border-bottom: 1px solid #F3DAF3;  height: 25px; line-height: 25px;">
				' . $sum_percent . '(%)
			</td>
			<td style="border-left: 1px solid #F3DAF3;border-right: 1px solid #F3DAF3;border-bottom: 1px solid #F3DAF3; height: 25px;"></td>
		</tr>                 
	</table>
	<br/>
	<br/>
	<table style="width: 100%;">
		<tr>
			<td style="border: 1px solid #F3DAF3; padding: 10px; line-height: 30px;">
				' . $this->lable['report_comment'] . ':
				<br/>
				' . $report_comment . '
			</td>
		</tr>
		<tr>
			<td style="text-align: right; height: 25px; padding: 7px; line-height: 65px;" align="right">
				' . $this->lable['staff_report'] . ':
				' . $staff_report . '
			</td>
		</tr>
	</table>';
...
EOF;
		...
		<table style="width: 100%;" class="wcorlor">
			<tr>
				<td class="w30 text-c" style="background-color:#A72529;">
					<img src="' . $footer_image_file . '" alt="A-Line">
				</td>
		...
		$pdf->writeHTMLCell(0, '', $PDF_MARGIN_LEFT, 260, $htmlFooter, 0, 0, false, true, 'L', false);
